...
shoppingListCtrlUnlimited.$inject = ['ShoppingListFactory'];
  function shoppingListCtrlUnlimited(ShoppingListFactory){
      ...
      list.quantity='';
       ...
       var originalMsg = 'Shopping List';
         list.title = originalMsg + ' (' + list.items.length + ' items) ';
  ...
  shoppingListCtrlLimited.$inject = ['ShoppingListFactory'];
